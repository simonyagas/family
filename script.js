...
const scenes = [
  {
    ...
    label: "SAVE FILE 2026",
    title: "PRESS START",
    text: "Para una noticia",
    button: "START",
    stageAction: "title",
    characters: [],
  },
  {
    ...
    text: "Equipo completo... por ahora.",
    button: "CONTINUE",
    stageAction: "enter",
  ...
  },
  {
    ...
    title: "Sobrevivimos al tutorial",
    text: "LEVEL UP: familia con experiencia",
    button: "CONTINUE",
    stageAction: "quest",
    characters: ["simon", "agus", "alma"],
  },
  {
    ...
    label: "PRIMERA ECO",
    title: "Algo chiquito y enorme",
    text: "Apareci\u00f3 una se\u00f1al nueva...",
    button: "CONTINUE",
  ...
  },
  {
    ...
    label: "DESBLOQUEADO",
    title: "Alma sube de nivel",
    text: "Rol nuevo: hermana mayor",
    button: "CONTINUE",
    buttonDelay: 2500,
  ...
  },
  {
    ...
    label: "SISTEMA",
    title: "Hay algo m\u00e1s.",
    text: "La eco sigue cargando...",
    button: "CONTINUE",
    buttonDelay: 2000,
    modifier: "is-blackout is-wait-glitch is-error",
    timedUpdates: [
      { delay: 520, status: "ERROR DE SE\u00d1AL", label: "ERROR", title: "ERROR: LA CUENTA NO CIERRA", text: "No cierres la partida", tone: "error" },
      { delay: 1250, status: "SE\u00d1AL INESTABLE", label: "ERROR", title: "SE DETECT\u00d3 OTRA SE\u00d1AL", text: "Recalculando...", tone: "error" },
    ],
    stageAction: "glitch",
    characters: [],
  },
  {
    ...
    label: "ERROR",
    title: "PLAYER 4 se uni\u00f3\nPLAYER 4 se uni\u00f3\nPLAYER 5 se uni\u00f3",
    text: "La cuenta no cierra",
    button: "CONTINUE",
    buttonDelay: 2400,
    ...
    timedUpdates: [
      ...
      { delay: 2050, status: "SISTEMA CORREGIDO", label: "NO ERA ERROR", title: "NO ERA ERROR", text: "La partida ven\u00eda con sorpresa", tone: "unlock" },
    ],
    items: ["ultrasound"],
